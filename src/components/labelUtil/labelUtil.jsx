...
import {FONT_FAMILIES, FONT_SIZES, TEXT_PROPS, useEditableText, getFontDefForExport, createTextSvgElementFromSpans} from "../../utils/utils";
...
export class LablShapeUtil extends ShapeUtil {
    static type = 'label';
	...
	getGeometry(shape) {
		...
		let { width, height } = this.getMinDimensions(shape);
		width+=20;
    ...
    toSvg(shape, ctx) {
		...
		rect1.setAttribute('width', width.toString())
		rect1.setAttribute('height', height.toString())
		rect1.setAttribute('fill', "red")
		rect1.setAttribute('stroke', "red")
		rect1.setAttribute('stroke-width', '1')

		groupEl.appendChild(rect1);
